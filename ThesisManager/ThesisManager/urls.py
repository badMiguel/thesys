...
urlpatterns = [
    ...
    path('thesis/modify/<int:topic_number>/', views.modify, name='modify'),
    path('thesis/modify/', views.modify, name='modify'),
    path('thesis/delete/<int:topic_number>', views.delete_data, name='delete_data'),
    path('thesis/delete/', views.delete_data, name='delete_data'),
